...
public class registration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //inflate
        et_name=findViewById(R.id.registration_et_name);
        et_email=findViewById(R.id.registration_et_email);
        et_password=findViewById(R.id.registration_et_password);
        et_rePassword=findViewById(R.id.registration_et_password);
        tv_login=findViewById(R.id.registration_tv_login);
        btn_create=findViewById(R.id.registration_btn_create);
            ...
            public void onClick(View view) {
                ...
                if(name.isEmpty() || email.isEmpty() || password.isEmpty() || rePassword.isEmpty())
                    ...
                    if(!isValidPassword){
                        ...
                        Intent completeSignUpIntent= new Intent(login.this,login.class);
