...
public class homeActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //inflate
        rg_gender = findViewById(R.id.home2_tv_Gender);
        tv_increment_weight = findViewById(R.id.home2_tv_Weight);
        tv_decrement_weight = findViewById(R.id.home2_tv_Weight);
        tv_increment_length = findViewById(R.id.home2_tv_Lenght);
        tv_decrement_length = findViewById(R.id.home2_tv_Lenght);
        et_birthday = findViewById(R.id.home2_tv_Datebd);
        btn_save = findViewById(R.id.home2_btn_SaveData);
